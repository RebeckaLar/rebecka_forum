import { preDefinedTags } from "./tag";
...
export const dummyThreads: (Thread | QNAThread)[] = [
  {
    ...
    description:
      "Lorem ipsum dolor sit amet, consectetur adipisicing elit. Corporis facilis iste aliquam earum itaque rerum veniam eligendi minus dignissimos vitae quidem ex, expedita deserunt obcaecati vero fugit pariatur ipsa est!",
    creator: dummyUsers[0],
    tags: [preDefinedTags[0]]
  },
  {
    id: 2,
